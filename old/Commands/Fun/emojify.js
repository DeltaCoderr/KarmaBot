...
<<<<<<< Updated upstream:Commands/Fun/emojify.js
...
module.exports = {
	...
	run: async (client, message, args) => {
		if (!args[0]) {
			return message.reply('Please provide valid text.');
		}
		...
		if (emojified.length > 2000) {
			return message.reply(
				`${emotes.error} The emojified message exceeds 2000 characters.`,
			);
		}
...
>>>>>>> Stashed changes:old/Commands/Fun/emojify.js
